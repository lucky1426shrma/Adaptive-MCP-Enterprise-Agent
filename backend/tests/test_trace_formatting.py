...
def test_format_span_id_full_64_bit_value() -> None:
    max_64_bit = (2**64) - 1
    formatted = format_span_id(max_64_bit)
    assert formatted == "f" * 16
...
def test_format_trace_id_is_lowercase() -> None:
    value = 0xABCDEF1234567890ABCDEF1234567890
    formatted = format_trace_id(value)
